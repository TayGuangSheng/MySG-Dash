const en = {
  ...
  dashboard: {
    ...
    lotteryCard: {
      title: "4D & Toto",
      fourDTitle: "4D results",
      fourDDescription: "Opens the official Singapore Pools 4D results page.",
      fourDShort: "4D",
      totoTitle: "Toto results",
      totoDescription: "Opens the official Singapore Pools Toto draw page.",
      totoShort: "Toto",
    },
    focusCard: {
      title: "Focus Flight",
      cockpitTitle: "Flight deck",
      subtitle: "Depart for a focus block, land for a break.",
      routeLabel: "Flight path",
      fromLabel: "Depart from",
      toLabel: "Arrive at",
      flightDurationLabel: "Flight time ~{{value}} min",
      flightUnavailable: "Route unavailable. Pick another pair.",
      ...
      divert: "Divert / Reset",
      breakMessage: "Landed. Take a short layover.",
      status: {
    ...
    quotes: {
      ...
      systemsOverGoals: {
        text: "You fall to the level of your systems if you don't improve.",
        author: "James Clear",
      },
      disciplineBridge: {
